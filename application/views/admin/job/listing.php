...
<a href="<?php echo base_url().'admin/manage_job/complete_listing'?>" target="_blank" class="category_btn"><?php echo 'Complete';?></a>
<a href="<?php echo base_url().'admin/manage_job/pending_listing'?>" target="_blank" class="category_btn"><?php echo 'Pending';?></a>
<a href="<?php echo base_url().'admin/manage_job/InProgress_listing'?>" target="_blank" class="category_btn"><?php echo 'InProgress';?></a>
</div>
	...
	foreach($result as $value){?>
            ...
            <td class='admin_table_options'>
              <a href="<?php echo base_url().'admin/manage_job/delete/'.$value->id?>" title="Delete" onclick="return confirm('Are you sure you want to delete ?');"><img src="<?php echo base_url().'public/images/b_drop.png'?>" alt="Delete"></a>&nbsp;&nbsp;
							...
							<td><a class="fancybox fancybox.ajax" href="<?php echo base_url().'admin/manage_job/job_detail/'.$value->id?>" title="Detail" ><button type="button">Detail</button></a></td>
           </tr>
               <?php }
}
else{
