...
<!--        personel          -->
		<table align="center" style=" padding-left: 350px; width:60%;">		
					<tr>			
				<td align="right">  </td>
				<td align="left"> </button> <a href="<?php echo base_url();?>admin/manage_payment/unapprove/<?php echo $id;?>"><button type="button" class="buttons" name="cancel" ><?php echo 'UnApprove';?></button></a></td>
